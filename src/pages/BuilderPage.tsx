...
import { ArrowLeft, ArrowRight, Bot, ChevronDown, Clipboard, Download, Plus, Sparkles, Trash2, X, Check, AlertTriangle, Sun, Moon, Printer, Eye } from 'lucide-react'
...
<Moon size={16} className="icon-light" /><Sun size={16} className="icon-dark" />
</button>
</header>
